...
const WhenToReplaceBrakeRotorsArticle = lazy(() => import("./pages/blog/WhenToReplaceBrakeRotorsArticle"));
const WhenToReplaceTiresArticle = lazy(() => import("./pages/blog/WhenToReplaceTiresArticle"));
const WhenToServiceCarAcArticle = lazy(() => import("./pages/blog/WhenToServiceCarAcArticle"));
const WhenToChangeOilFilterArticle = lazy(() => import("./pages/blog/WhenToChangeOilFilterArticle"));
const WhyIsMyCarOverheatingArticle = lazy(() => import("./pages/blog/WhyIsMyCarOverheatingArticle"));
...
const WhyIsMySteeringWheelShakingArticle = lazy(() => import("./pages/blog/WhyIsMySteeringWheelShakingArticle"));
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            <Suspense fallback={<ChunkLoading />}>
              <WhenToReplaceBrakeRotorsArticle />
            </Suspense>
          }
        />
        <Route
        ...
        <Route
          ...
          element={
            <Suspense fallback={<ChunkLoading />}>
              <WhyAreMyBrakesSqueakingArticle />
            </Suspense>
          }
        />
        <Route
        ...
        <Route
          ...
          element={
            <Suspense fallback={<ChunkLoading />}>
              <WhyIsMySteeringWheelShakingArticle />
            </Suspense>
          }
        />
        <Route
          ...
          element={
            <Suspense fallback={<ChunkLoading />}>
              <WhyIsMyCarPullingToOneSideArticle />
            </Suspense>
          }
        />
        <Route
          ...
          element={
            <Suspense fallback={<ChunkLoading />}>
              <WhyDoesMyCarBatteryKeepDyingArticle />
            </Suspense>
          }
        />
        <Route
